    ...
    @endif
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('crud.reorder').' '.$crud->labelPlural }}</h3>
            </div>
...
@push('after_styles')
<link rel="stylesheet" href="{{ asset('public/vendor/lara/nestedSortable/nestedSortable.css') }}">
<link rel="stylesheet" href="{{ asset('public/vendor/lara/crud/css/crud.css') }}">
<link rel="stylesheet" href="{{ asset('public/vendor/lara/crud/css/reorder.css') }}">
@endpush

@push('after_scripts')
<script src="{{ asset('public/vendor/lara/crud/js/crud.js') }}"></script>
<script src="{{ asset('public/vendor/lara/crud/js/reorder.js') }}"></script>
<script src="https://code.jquery.com/ui/1.11.3/jquery-ui.min.js" type="text/javascript"></script>
<script src="{{ url('vendor/lara/nestedSortable/jquery.mjs.nestedSortable2.js') }}" type="text/javascript"></script>

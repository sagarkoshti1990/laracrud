...
?>
<div ng-app="laraTableApp" ng-controller="tableController" @include(config('stlc.stlc_modules_folder_name','stlc::').'inc.field_wrapper_attributes') >
...
@pushonce('crud_fields_scripts')
    ...
    <script>
        window.angularApp = window.angularApp || angular.module('laraTableApp', ['ui.sortable'], function($interpolateProvider){

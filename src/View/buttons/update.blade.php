@if ($crud->hasAccess('edit'))
	...
	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> {{ trans('stlc.edit') }}</a>
	  ...
	  <ul class="dropdown-menu dropdown-menu-right">
  	    <li class="dropdown-header">{{ trans('stlc.edit_translations') }}:</li>

...
trait Fields
{
    ...
    public function decodeJsonCastedAttributes($data)
    {
        ...
        foreach ($fields as $field) {
            ...
            if(isset($field->field_type->name) && in_array($field->field_type->name, ['Multiselect','Select2_multiple','Select2_from_array_multiple','Select2_from_ajax_multiple','Checkbox','Select2_multiple_tags'])) {
